...
const nextConfig: NextConfig = {
  ...
  // instead of a Node/Workers runtime: nothing to run, nothing to bill, and
  ...
  // to want is a contact-form endpoint — see the deploy notes.
  output: "export",
  turbopack: {
